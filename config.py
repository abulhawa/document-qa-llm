...
# ── Background indexing thresholds
CHUNK_EMBEDDING_THRESHOLD    = _env_int("CHUNK_EMBEDDING_THRESHOLD", 60)
MAX_FILES_FOR_FULL_EMBEDDING = _env_int("MAX_FILES_FOR_FULL_EMBEDDING", 15)
...
INGEST_PLAN_INDEX_BASE = _env_str("INGEST_PLAN_INDEX_BASE", "ingest_plans")
OPENSEARCH_INDEX       = _namespaced(OPENSEARCH_INDEX_BASE)
INGEST_LOG_INDEX       = _namespaced(INGEST_LOG_INDEX_BASE)
INGEST_PLAN_INDEX      = _namespaced(INGEST_PLAN_INDEX_BASE)
...
def dump_config_for_debug() -> None:
    safe = {
        ...
        "INGEST_LOG_INDEX": INGEST_LOG_INDEX, "INGEST_PLAN_INDEX": INGEST_PLAN_INDEX,
        "QDRANT_URL": QDRANT_URL, "QDRANT_COLLECTION": QDRANT_COLLECTION,
        "USE_STUB_EMBEDDER": USE_STUB_EMBEDDER, "USE_STUB_LLM": USE_STUB_LLM,
