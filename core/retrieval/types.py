...
class RetrievalConfig:
    ...
    canonical_lexical_rescue_enabled: bool = True
    canonical_lexical_rescue_max_score_gap: float = 0.20
    canonical_lexical_rescue_min_bm25: float = 0.85
    canonical_lexical_rescue_min_bm25_advantage: float = 0.08
    canonical_lexical_rescue_strong_bm25_advantage: float = 0.25
    canonical_lexical_rescue_min_title_overlap_ratio: float = 0.40
    canonical_lexical_rescue_min_title_overlap_count: int = 2
    canonical_hard_negative_suppression_enabled: bool = True
    canonical_hard_negative_max_score_gap: float = 0.55
